...
define('SKT_SOLAR_ENERGY_SKTTHEMES_URL','https://www.sktthemes.org/','skt-solar-energy');
define('SKT_SOLAR_ENERGY_SKTTHEMES_PRO_THEME_URL','https://www.sktthemes.org/shop/solar-energy-wordpress-theme/','skt-solar-energy');
define('SKT_SOLAR_ENERGY_SKTTHEMES_FREE_THEME_URL','https://www.sktthemes.org/shop/free-clean-energy-wordpress-theme/','skt-solar-energy');
define('SKT_SOLAR_ENERGY_SKTTHEMES_THEME_DOC','http://sktthemesdemo.net/documentation/solar-energy-documentation/','skt-solar-energy');
define('SKT_SOLAR_ENERGY_SKTTHEMES_LIVE_DEMO','http://sktperfectdemo.com/demos/solarenergy/','skt-solar-energy');
define('SKT_SOLAR_ENERGY_SKTTHEMES_THEMES','https://www.sktthemes.org/themes/','skt-solar-energy');
/**
